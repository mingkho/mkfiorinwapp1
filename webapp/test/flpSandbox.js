		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#mkfiorinwapp1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mkfiorinwapp1-display": {
								"semanticObject": "mkfiorinwapp1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mkfiorinwapp1",
									"url": sap.ui.require.toUrl("mkfiorinwapp1")
								}
							}
						}
					}
